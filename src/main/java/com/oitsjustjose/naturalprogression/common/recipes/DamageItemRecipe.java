...
public class DamageItemRecipe extends ShapelessRecipe
{
    ...
    public boolean matches(CraftingInventory inv, World world)
    {
        ...
        return i == this.inputs.size() && recipeitemhelper.canCraft(this, (IntList) null);
    }
    ...
    {
        @Override
        public DamageItemRecipe read(ResourceLocation recipeId, JsonObject json)
        {
        ...
        @Override
        public DamageItemRecipe read(ResourceLocation recipeId, PacketBuffer buffer)
        {
